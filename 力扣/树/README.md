...
| [513](https://leetcode.cn/problems/find-bottom-left-tree-value/) | [找树左下角的值](https://github.com/wenshuo-zh/algorithm-practice/blob/main/力扣/树/513找树左下角的值.cpp) | 递归、层序遍历 | 最深层第一个节点是最左节点 |
| [112](https://leetcode.cn/problems/path-sum/) | [路径总和](https://github.com/wenshuo-zh/algorithm-practice/blob/main/力扣/树/112路径总和.cpp) | DFS + 回溯 | 到叶子节点时判断剩余和是否为 0 |
...
| [701](https://leetcode.cn/problems/insert-into-a-binary-search-tree/) | [二叉搜索树的插入操作](https://github.com/wenshuo-zh/algorithm-practice/blob/main/力扣/树/701二叉搜索树的插入操作.cpp) | BST递归、迭代插入 | 空树时新节点直接作根 |
...
| [700](https://leetcode.cn/problems/search-in-a-binary-search-tree/) | [二叉搜索树中的搜索](https://github.com/wenshuo-zh/algorithm-practice/blob/main/力扣/树/700二叉搜索树中的搜索.cpp) | BST递归、迭代搜索 | 利用左小右大的性质缩小范围 |
| [98](https://leetcode.cn/problems/validate-binary-search-tree/) | [验证二叉搜索树](https://github.com/wenshuo-zh/algorithm-practice/blob/main/力扣/树/98验证二叉搜索树.cpp) | 中序遍历 | BST中序遍历必须严格递增 |
...
| [450](https://leetcode.cn/problems/delete-node-in-a-bst/) | [删除二叉搜索树中的节点](https://github.com/wenshuo-zh/algorithm-practice/blob/main/力扣/树/450删除二叉搜索树中的节点.cpp) | BST 删除 | 左右都不空：右子树最小节点替换（值替换法），或左子树接到右子树最左端（子树搬迁法） |
| [669](https://leetcode.cn/problems/trim-a-binary-search-tree/) | [修剪二叉搜索树](https://github.com/wenshuo-zh/algorithm-practice/blob/main/力扣/树/669修剪二叉搜索树.cpp) | 递归 / 迭代 | 小于 low 用右子树顶替，大于 high 用左子树顶替 |
...
| [538](https://leetcode.cn/problems/convert-bst-to-greater-tree/) | [把二叉搜索树转换为累加树](https://github.com/wenshuo-zh/algorithm-practice/blob/main/力扣/树/538把二叉搜索树转换为累加树.cpp) | 反中序遍历 | 右 → 中 → 左 的顺序累加 |
